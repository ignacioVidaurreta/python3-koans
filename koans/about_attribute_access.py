...
class AboutAttributeAccess(Koan):
    ...
    def test_calling_getattribute_causes_an_attribute_error(self):
        ...
        # We could redefine it to do special things, but be careful, because
        # redefining it could end up in an infinte recursion if you are not 
        # careful. 
        # See: https://stackoverflow.com/questions/371753/how-do-i-implement-getattribute-without-an-infinite-recursion-error
